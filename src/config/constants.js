...
export const CHAIN_ID = 42161; // Arc Network chain ID
export const CHAIN_NAME = 'Arc Network';
export const RPC_URL = process.env.VITE_RPC_URL || 'https://rpc.arc.network';
export const BLOCK_EXPLORER = 'https://explorer.arc.network';
